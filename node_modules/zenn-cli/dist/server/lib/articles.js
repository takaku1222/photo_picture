...
function getArticleFilenames(sort) {
    var dirpath = (0, helper_1.getWorkingPath)('articles');
...
function readArticleFile(slug) {
    var fullpath = (0, helper_1.getWorkingPath)("articles/".concat(slug, ".md"));
    var raw = (0, helper_1.getFileRaw)(fullpath);
    if (!raw) {
        Log.error("".concat(fullpath, "\u306E\u5185\u5BB9\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F"));
        return null;
    }
    var _a = (0, gray_matter_1.default)(raw), data = _a.data, bodyMarkdown = _a.content;
    return {
