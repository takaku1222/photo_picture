...
function createApp() {
    ...
    app.get('/images/*', function (req, res) {
        ...
        res.sendFile((0, helper_1.getWorkingPath)(req.path));
    });
    // serve static files built by vite
    app.use((0, connect_history_api_fallback_1.default)()); // required to directly access non-root pages such as /guide, /articles/foo
