...
function getBook(req, res) {
    ...
    var book = (0, books_1.getLocalBook)(slug);
    if (!book) {
        res.status(404).json({
...
function getBooks(req, res) {
    var sort = (0, helper_1.getValidSortTypes)(req.query.sort);
    var books = (0, books_1.getLocalBookMetaList)(sort);
    res.json({ books: books });
}
exports.getBooks = getBooks;
function getChapter(req, res) {
    var bookSlug = req.params.book_slug;
    var book = (0, books_1.getLocalBookMeta)(bookSlug);
    if (!book) {
        res.status(404).json({
            message: bookNotFoundMessage,
        });
    ...
    var chapter = (0, books_1.getLocalChapter)(book, chapterFilename);
    if (!chapter) {
        res
            .status(404)
...
function getChapters(req, res) {
    ...
    var chapters = (0, books_1.getLocalChapterMetaList)(book);
