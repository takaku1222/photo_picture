...
var exec = function (argv) {
    ...
    var slug = args['--slug'] || (0, helper_1.generateSlug)();
    var title = args['--title'] || '';
    var summary = args['--summary'] || '';
    var published = args['--published'] === 'true' ? 'true' : 'false'; // デフォルトはfalse
    var price = args['--price'] || 0; // デフォルトは¥0
    if (!(0, helper_2.validateSlug)(slug)) {
        Log.error((0, helper_2.getSlugErrorMessage)(slug));
        return;
    }
    var configYamlBody = [
        "title: \"".concat(title.replace(/"/g, '\\"'), "\""),
        "summary: \"".concat(summary.replace(/"/g, '\\"'), "\""),
        'topics: []',
        "published: ".concat(published),
        "price: ".concat(price, " # \u6709\u6599\u306E\u5834\u5408200\u301C5000"),
        "# \u672C\u306B\u542B\u3081\u308B\u30C1\u30E3\u30D7\u30BF\u30FC\u3092\u9806\u756A\u306B\u4E26\u3079\u307E\u3057\u3087\u3046",
        "chapters:",
        "  - example1",
        "  - example2",
    ].join('\n') + '\n';
    var relativeConfigYamlPath = "books/".concat(slug, "/config.yaml");
    var configYamlPath = (0, helper_1.getWorkingPath)(relativeConfigYamlPath);
    try {
        (0, helper_1.generateFileIfNotExist)(configYamlPath, configYamlBody);
    ...
    ['example1.md', 'example2.md'].forEach(function (chapterFileName) {
        try {
            var relativeChapterFilePath = "books/".concat(slug, "/").concat(chapterFileName);
            (0, helper_1.generateFileIfNotExist)((0, helper_1.getWorkingPath)(relativeChapterFilePath), initialChapterBody);
