...
var exec = function (argv) {
    ...
    mkDirNames.forEach(function (dirName) {
        var createFilePath = (0, helper_1.getWorkingPath)("".concat(dirName, "/.keep"));
        try {
            (0, helper_1.generateFileIfNotExist)(createFilePath, '');
        }
        catch (e) {
            console.log("Generating ".concat(dirName, " skipped."));
        }
    });
    // generate .gitignore
    try {
        (0, helper_1.generateFileIfNotExist)((0, helper_1.getWorkingPath)('.gitignore'), ['node_modules', '.DS_Store'].join('\n'));
    }
    catch (e) {
    ...
    // generate README.md
    try {
        (0, helper_1.generateFileIfNotExist)((0, helper_1.getWorkingPath)('README.md'), [
            '# Zenn CLI\n',
