...
function convertAutolinkToEmbed(inlineChildTokens) {
    ...
    inlineChildTokens.forEach(function (token, i) {
        ...
        if ((0, url_matcher_1.isYoutubeUrl)(url)) {
            embedToken.content = (0, helper_1.generateYoutubeHtmlFromUrl)(url);
        }
        else if ((0, url_matcher_1.isTweetUrl)(url)) {
            embedToken.content = (0, helper_1.generateEmbedIframe)('tweet', url);
        }
        else if ((0, helper_1.isGithubUrl)(url)) {
            embedToken.content = (0, helper_1.generateEmbedIframe)('github', url);
        }
        else {
            embedToken.content = (0, helper_1.generateEmbedIframe)('link-card', url);
        }
